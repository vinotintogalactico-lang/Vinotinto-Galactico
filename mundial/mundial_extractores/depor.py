...
class DeporExtractor(GenericExtractor):
    ...
    async def _extract_article(self, context, url: str) -> dict | None:
        ...
        try:
            ...
            subtitle = soup.select_one(".article__subtitle, .story__subtitle, h2")
            subtitle_text = subtitle.get_text(strip=True) if subtitle else ""

            author = soup.select_one(".author__name, .article__author, .author")
            ...
            if time_el and time_el.get("datetime"):
                ...
                d = soup.select_one("time, .article__date")
