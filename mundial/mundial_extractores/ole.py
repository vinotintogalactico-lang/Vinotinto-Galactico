...
class OleExtractor(GenericExtractor):
    ...
    async def _extract_article(self, context, url: str) -> dict | None:
        ...
        try:
            ...
            subtitle = soup.select_one(".article-summary, .volanta, h2.bajada")
            subtitle_text = subtitle.get_text(strip=True) if subtitle else ""

            author = soup.select_one(".author-name, .firma, .author")
            ...
            if time_el and time_el.get("datetime"):
                ...
                d = soup.select_one("time, .date, .fecha")
