...
class GenericExtractor:
    ...
    async def extract(self) -> tuple[list[dict], dict]:
        # TRUCO DE RAM: Limpiar la memoria antes de empezar la extracción
        gc.collect() 
        ...
        try:
            async with async_playwright() as pw:
                # TRUCO DE RAM: Argumentos básicos de seguridad para la nube
                ...
                # TRUCO DE RAM: Cerramos la página inicial antes de seguir
                await page.close()
